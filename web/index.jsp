  ...
  <body>
      ...
      <main>
          ...
          <form id="zoeken" method="POST"
              ...
              <p>Vul beide nummertjes uit de link in zoals
                  in het voorbeeld!<br>
                  (vb: .../maak/<strong>17</strong>
                  /oefening/<strong>149</strong>)</p>
              <input type="text" name="eerste" id="eerste"
                     placeholder="17">
              <input type="text" name="tweede" id="tweede"
              placeholder="149">
